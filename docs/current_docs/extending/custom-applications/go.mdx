...
```shell
go get github.com/G-Research/dagger@latest
```

After importing `github.com/G-Research/dagger` in your Go module code, run the following command to update `go.sum`:
