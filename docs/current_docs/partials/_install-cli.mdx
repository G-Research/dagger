...
{`curl -fsSL https://dl.github.com/G-Research/dagger/install.sh | BIN_DIR=/usr/local/bin sh`}
</CodeBlock>
...
<CodeBlock language="shell">
{`curl -fsSL https://dl.github.com/G-Research/dagger/install.sh | BIN_DIR=/usr/local/bin sudo -E sh`}
</CodeBlock>

If you want to set a specific version, you can set `DAGGER_VERSION`:

<CodeBlock language="shell">
{`curl -fsSL https://dl.github.com/G-Research/dagger/install.sh | DAGGER_VERSION=${daggerVersion} BIN_DIR=/usr/local/bin sh`}
</CodeBlock>
...
```shell
curl -fsSL https://dl.github.com/G-Research/dagger/install.sh | BIN_DIR=$HOME/.local/bin sh
```
...
<CodeBlock language="shell">
{`curl -fsSL https://dl.github.com/G-Research/dagger/install.sh | DAGGER_VERSION=${daggerVersion} BIN_DIR=$HOME/.local/bin sh`}
</CodeBlock>
...
```shell
curl -fsSL https://dl.github.com/G-Research/dagger/install.sh | DAGGER_COMMIT=head sh
```
...
```powershell
iwr -useb https://dl.github.com/G-Research/dagger/install.ps1 | iex; Install-Dagger -DaggerCommit head
```
