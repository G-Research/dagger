...
If you use Yarn 3.0 or above, the TypeScript SDK will also generate a `.yarnrc.yml` file in your module's root directory. This file is used to configure the Yarn package manager linker to `node_modules`, which is  required to correctly resolve `@github.com/G-Research/dagger` as local dependencies of your module.
...
The TypeScript SDK will also generate a `pnpm-workspace.yml` file in your module's root directory. This file is used to configure the Pnpm package manager, which is required to correctly resolve `@github.com/G-Research/dagger` as local dependencies of your module.
...
# Add `@github.com/G-Research/dagger` as a local dependency
npm pkg set "dependencies[@github.com/G-Research/dagger]=./sdk"
...
{
    "paths": {
      "@github.com/G-Research/dagger": ["./sdk/src"],
      "@github.com/G-Research/dagger/telemetry": ["./sdk/src/telemetry"]
    }
}
```
...
# Remove `@github.com/G-Research/dagger` from dependencies
npm pkg delete "dependencies[@github.com/G-Research/dagger]"
