...
import (
	...
	"github.com/G-Research/dagger/internal/buildkit/exporter/containerimage"
...
const (
	VariantOCI    ExporterVariant = client.ExporterOCI
	VariantDocker ExporterVariant = client.ExporterDocker
)
