...
import (
	...
	sessionauth "github.com/G-Research/dagger/internal/buildkit/session/auth"
	log "github.com/G-Research/dagger/internal/buildkit/util/bklog"
...
func (ah *authHandler) fetchToken(ctx context.Context, sm *session.Manager, g session.Group, to auth.TokenOptions) (r *authResult, err error) {
	...
	if ah.authority != nil {
		...
		expires = int(resp.ExpiresInSeconds)
